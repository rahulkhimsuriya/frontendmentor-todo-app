  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="relative">
        <span
          className={`absolute left-4 top-3 rounded-full ${isCompleted && ''}`}
        >
          <TodoCompleteButton completed={isCompleted} toggleTodo={toggleTodo} />
        </span>
        <input
          type="text"
          className="pl-14 pr-4 py-3 w-full text-gray-800 dark:text-gray-100 tracking-wide bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 rounded-md"
